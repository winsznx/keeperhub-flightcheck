...
gives them. The standalone artifact already is that command. If you want it attempted anyway,
that is a clear next task and I would start from `cmd/doctor/doctor.go`.
